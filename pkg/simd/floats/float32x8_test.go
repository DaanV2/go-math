...
func Test_Float32x8_Ops(t *testing.T) {
	...
	vec1 := simdfloats.NewFloat32x8(dataA)
	vec2 := simdfloats.NewFloat32x8(dataB)
	vec3 := simdfloats.NewFloat32x8(dataC)
	...
	t.Run("Abs", func(t *testing.T) {
		vec := simdfloats.NewFloat32x8([]float32{1, -2, -3, 4, -5, 6, -7, 8})
		result := vec.Abs()
	...
	t.Run("Scale", func(t *testing.T) {
		exponents := simdfloats.NewFloat32x8([]float32{1, 0, 2, 1, 0, 3, 1, 0})
...
func Test_Float32x8_Load(t *testing.T) {
	...
	assert.Equal(t, simdfloats.NewFloat32x8(data).ToSlice(), data[:8])
	assert.Equal(t, []float32{1, 0, 0, 0, 0, 0, 0, 0}, simdfloats.NewFloat32x8(data[:1]).ToSlice())
	assert.Equal(t, []float32{1, 2, 3, 4, 5, 6, 7, 0}, simdfloats.NewFloat32x8(data[:7]).ToSlice())
}
...
func Test_Float32x8Slice(t *testing.T) {
	...
	result := simdfloats.NewFloat32x8Slice(data)
...
func ExampleFloat32x8() {
	...
	v1 := simdfloats.NewFloat32x8(data)
