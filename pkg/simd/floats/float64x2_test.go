...
func Test_Float64x2_Ops(t *testing.T) {
	...
	dataB := []float64{5, 6}
	dataC := []float64{9, 10}
	vec1 := simdfloats.NewFloat64x2(dataA)
	vec2 := simdfloats.NewFloat64x2(dataB)
	vec3 := simdfloats.NewFloat64x2(dataC)
	...
	t.Run("Abs", func(t *testing.T) {
		vec := simdfloats.NewFloat64x2([]float64{1, -2})
		result := vec.Abs()
	...
	t.Run("Scale", func(t *testing.T) {
		exponents := simdfloats.NewFloat64x2([]float64{1, 0})
...
func Test_Float64x2_Load(t *testing.T) {
	...
	assert.Equal(t, simdfloats.NewFloat64x2(data).ToSlice(), data[:2])
	assert.Equal(t, []float64{1, 0}, simdfloats.NewFloat64x2(data[:1]).ToSlice())
}
...
func Test_Float64x2Slice(t *testing.T) {
	...
	result := simdfloats.NewFloat64x2Slice(data)
...
func ExampleFloat64x2() {
	...
	v1 := simdfloats.NewFloat64x2(data)
