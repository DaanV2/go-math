...
func Test_Float64x4_Ops(t *testing.T) {
	...
	vec1 := simdfloats.NewFloat64x4(dataA)
	vec2 := simdfloats.NewFloat64x4(dataB)
	vec3 := simdfloats.NewFloat64x4(dataC)
	...
	t.Run("Abs", func(t *testing.T) {
		vec := simdfloats.NewFloat64x4([]float64{1, -2, -3, 4})
		result := vec.Abs()
	...
	t.Run("Scale", func(t *testing.T) {
		exponents := simdfloats.NewFloat64x4([]float64{1, 0, 2, 1})
...
func Test_Float64x4_Load(t *testing.T) {
	...
	assert.Equal(t, simdfloats.NewFloat64x4(data).ToSlice(), data[:4])
	assert.Equal(t, []float64{1, 0, 0, 0}, simdfloats.NewFloat64x4(data[:1]).ToSlice())
	assert.Equal(t, []float64{1, 2, 3, 0}, simdfloats.NewFloat64x4(data[:3]).ToSlice())
}
...
func Test_Float64x4Slice(t *testing.T) {
	...
	result := simdfloats.NewFloat64x4Slice(data)
...
func ExampleFloat64x4() {
	...
	v1 := simdfloats.NewFloat64x4(data)
