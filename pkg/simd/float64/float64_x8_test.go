...
func Test_Float64x8_Ops(t *testing.T) {
	...
	vec1 := simdfloat64.NewFloat64x8(dataA)
	vec2 := simdfloat64.NewFloat64x8(dataB)
	vec3 := simdfloat64.NewFloat64x8(dataC)
	...
	t.Run("Abs", func(t *testing.T) {
		vec := simdfloat64.NewFloat64x8([]float64{1, -2, -3, 4, -5, 6, -7, 8})
		result := vec.Abs()
	...
	t.Run("Scale", func(t *testing.T) {
		exponents := simdfloat64.NewFloat64x8([]float64{1, 0, 2, 1, 0, 3, 1, 0})
...
func Test_Float64x8_Load(t *testing.T) {
	...
	assert.Equal(t, simdfloat64.NewFloat64x8(data).ToSlice(), data[:8])
	assert.Equal(t, []float64{1, 0, 0, 0, 0, 0, 0, 0}, simdfloat64.NewFloat64x8(data[:1]).ToSlice())
	assert.Equal(t, []float64{1, 2, 3, 4, 5, 6, 7, 0}, simdfloat64.NewFloat64x8(data[:7]).ToSlice())
}
...
func Test_Float64x8Slice(t *testing.T) {
	...
	result := simdfloat64.NewFloat64x8Slice(data)
...
func ExampleFloat64x8() {
	...
	v1 := simdfloat64.NewFloat64x8(data)
