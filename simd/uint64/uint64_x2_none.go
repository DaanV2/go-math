...
func (x Uint64x2) Add(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
...
func (x Uint64x2) Mul(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] * y.data[i]
	}
...
func (x Uint64x2) Max(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
...
func (x Uint64x2) Min(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
...
func (x Uint64x2) Sub(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] - y.data[i]
	}
...
func (x Uint64x2) And(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] & y.data[i]
	}
...
func (x Uint64x2) AndNot(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] &^ y.data[i]
	}
...
func (x Uint64x2) Or(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] | y.data[i]
	}
...
func (x Uint64x2) Xor(y Uint64x2) (result Uint64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] ^ y.data[i]
	}
...
func (x Uint64x2) Not() (result Uint64x2) {
	for i := range x.data {
...
func (x Uint64x2) ShiftLeft(count uint) (result Uint64x2) {
	for i := range x.data {
...
func (x Uint64x2) ShiftRight(count uint) (result Uint64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] >> count
	}
