...
func NewUint64x8Boardcast(value uint64) Uint64x8 {
	buf := [uint64_x8_len]uint64{value, value, value, value, value, value, value, value}

	return NewUint64x8(buf[:])
}
...
func (x Uint64x8) Add(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
...
func (x Uint64x8) Mul(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
		result.data[i] = x.data[i] * y.data[i]
	}
...
func (x Uint64x8) Max(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
...
func (x Uint64x8) Min(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
...
func (x Uint64x8) Sub(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
		result.data[i] = x.data[i] - y.data[i]
	}
...
func (x Uint64x8) And(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
		result.data[i] = x.data[i] & y.data[i]
	}
...
func (x Uint64x8) AndNot(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
		result.data[i] = x.data[i] &^ y.data[i]
	}
...
func (x Uint64x8) Or(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
		result.data[i] = x.data[i] | y.data[i]
	}
...
func (x Uint64x8) Xor(y Uint64x8) (result Uint64x8) {
	for i := range x.data {
		result.data[i] = x.data[i] ^ y.data[i]
	}
...
func (x Uint64x8) Not() (result Uint64x8) {
	for i := range x.data {
...
func (x Uint64x8) ShiftLeft(count uint) (result Uint64x8) {
	for i := range x.data {
...
func (x Uint64x8) ShiftRight(count uint) (result Uint64x8) {
	for i := range x.data {
		result.data[i] = x.data[i] >> count
	}
