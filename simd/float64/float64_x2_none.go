...
func (x Float64x2) Abs() (result Float64x2) {
	for i := range x.data {
...
func (x Float64x2) Add(y Float64x2) (result Float64x2) {
	for i := range x.data {
...
func (x Float64x2) Div(y Float64x2) (result Float64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] / y.data[i]
	}
...
func (x Float64x2) Mul(y Float64x2) (result Float64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] * y.data[i]
	}
...
func (x Float64x2) MulAdd(y, z Float64x2) (result Float64x2) {
	for i := range x.data {
...
func (x Float64x2) Max(y Float64x2) (result Float64x2) {
	for i := range x.data {
...
func (x Float64x2) Min(y Float64x2) (result Float64x2) {
	for i := range x.data {
...
func (x Float64x2) Neg() (result Float64x2) {
	for i := range x.data {
...
func (x Float64x2) Scale(y Float64x2) (result Float64x2) {
	for i := range x.data {
...
func (x Float64x2) Sub(y Float64x2) (result Float64x2) {
	for i := range x.data {
		result.data[i] = x.data[i] - y.data[i]
	}
...
func (x Float64x2) Sqrt() (result Float64x2) {
	for i := range x.data {
